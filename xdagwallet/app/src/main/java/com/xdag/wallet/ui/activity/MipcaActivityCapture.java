...
import com.xdag.wallet.zxing.view.ViewfinderView;
...
public class MipcaActivityCapture extends BaseActivity implements Callback {
    ...
    private TextView tvOpenFlame;
    private Camera camera;
    private boolean isFalshLampOpen;//闪光灯是否开着
        ...
        tvOpenFlame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isFalshLampOpen) {
                    ...
                    tvOpenFlame.setText("打开闪光灯");
                } else {
                    //开闪光灯
                    CameraManager.get().openLight();
                    tvOpenFlame.setText("关闭闪光灯");
                }
                isFalshLampOpen = !isFalshLampOpen;
            }
        });
    }
