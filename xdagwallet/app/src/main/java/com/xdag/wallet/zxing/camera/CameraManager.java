...
package com.xdag.wallet.zxing.camera;
...
public final class CameraManager {
    ...
    private int MIN_FRAME_WIDTH = 240; // 240
    private int MIN_FRAME_HEIGHT = 240; // 240
    private int MAX_FRAME_WIDTH = 240; // 480
    private int MAX_FRAME_HEIGHT = 240; // 360
    ...
    private CameraManager(Context context) {
        ...
        MIN_FRAME_WIDTH = DensityUtils.dp2px(context, MIN_FRAME_WIDTH);
        MIN_FRAME_HEIGHT = DensityUtils.dp2px(context, MIN_FRAME_HEIGHT);
        MAX_FRAME_WIDTH = DensityUtils.dp2px(context, MAX_FRAME_WIDTH);
        MAX_FRAME_HEIGHT = DensityUtils.dp2px(context, MAX_FRAME_HEIGHT);
    }
    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            int height = /*screenResolution.y * 3 / 4*/MIN_FRAME_HEIGHT;
...
//            }
            ...
            int topOffset = /*(screenResolution.y - height) / 2*/DensityUtils.dp2px(context, 90);
